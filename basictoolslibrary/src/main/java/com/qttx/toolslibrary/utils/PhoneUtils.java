...
public final class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) AppUtils.getApp()
    ...
    public static void dial(final String phoneNumber) {
        AppUtils.getApp().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(final String phoneNumber) {
        AppUtils.getApp().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(final String phoneNumber, final String content) {
        AppUtils.getApp().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(final String phoneNumber, final String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(AppUtils.getApp(), 0, new Intent(), 0);
    ...
    public static  String getAppVersionCode() {
        ...
        try {
            PackageInfo packinfo = packageManager.getPackageInfo(
                    AppUtils.getApp().getPackageName(), 0);
