...
public final class DeviceUtils {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(AppUtils.getApp().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void reboot(final String reason) {
        PowerManager mPowerManager = (PowerManager) AppUtils.getApp().getSystemService(Context.POWER_SERVICE);
        try {
