...
public class NestFullListView extends LinearLayout {
    ...
    private NestFullViewAdapter mAdapter;
     ...
     * @param mAdapter
     */
    public void setAdapter(NestFullViewAdapter mAdapter) {
                ...
                for (int i = 0; i < mAdapter.getDatas().size(); i++) {
                    ...
                    holder.getConvertView().setOnLongClickListener(new OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            if (mOnItemClickListener != null && mAdapter != null) {
                                mOnItemClickListener.onLongItemClick(NestFullListView.this, v, mPosition);
                            }
                            return true;
                        }
                    });
    ...
    public interface OnItemClickListener {
        ...
        void onLongItemClick(NestFullListView parent, View view, int position);
    }
    @Override
