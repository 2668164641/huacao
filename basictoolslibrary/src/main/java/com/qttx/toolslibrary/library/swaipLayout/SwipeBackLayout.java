...
public class SwipeBackLayout extends FrameLayout {
     ...
     * @param  edgeFlag of edge flags describing the edge to set
     * @see #EDGE_LEFT
     * @see #EDGE_RIGHT
     * @see #EDGE_BOTTOM
     */
