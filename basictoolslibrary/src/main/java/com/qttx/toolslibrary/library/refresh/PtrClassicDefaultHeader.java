...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private int mRotateAniTime = 170;
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mProgressBar = (AVLoadingIndicatorView) header.findViewById(R.id.ptr_classic_header_rotate_view_progressbar);
        resetView();
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        mProgressBar.setVisibility(INVISIBLE);
        mRotateView.setImageResource(R.drawable.toolslib_drop_down_drop_down);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mRotateView.setVisibility(VISIBLE);
        mRotateView.setImageResource(R.drawable.toolslib_drop_down_duigou);
        mTitleTextView.setVisibility(VISIBLE);
