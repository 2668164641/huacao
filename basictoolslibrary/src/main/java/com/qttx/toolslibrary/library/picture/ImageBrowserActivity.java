...
import com.qttx.toolslibrary.base.BasePresenter;
...
public class ImageBrowserActivity extends BaseActivity implements
    ...
    public static void showActivity(Context context, ArrayList<String> path, int position) {
        showActivity(context, path.toArray(new String[]{}), position);
    }
    ...
    protected void processLogic() {
        ...
        save_tv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                requsetPerMission(10010, Manifest.permission.WRITE_EXTERNAL_STORAGE);
            }
        });
                    ...
                    public void subscribe(ObservableEmitter<Integer> e) throws Exception {
                        ...
                        .doOnSubscribe(new Consumer<Disposable>() {
                            ...
                            public void accept(Disposable disposable) throws Exception {
                                spotsDialog = new SpotsDialog(context, "下载中");
                                spotsDialog.show();
                            }
                        })
