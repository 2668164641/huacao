...
/**
 * RecyclerView gridview时的分割线,解决第一个比较宽的bug
 */
...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public boolean isHasFooteView() {
        return hasFooteView;
    }

    public void setHasFooteView(boolean hasFooteView) {
        this.hasFooteView = hasFooteView;
    }

    private boolean hasFooteView;
