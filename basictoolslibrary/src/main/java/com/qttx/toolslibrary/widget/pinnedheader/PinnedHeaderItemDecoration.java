...
public class PinnedHeaderItemDecoration extends RecyclerView.ItemDecoration implements IPinnedHeaderDecoration {
    ...
    public PinnedHeaderItemDecoration(RecyclerAdapter adapter) {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getChildCount() > 0) {
            ...
            if (pinnedHeaderPosition != -1) {
                RecyclerViewHolder pinnedHeaderViewHolder = adapter.onCreateViewHolder(parent,
     ...
     * @return -1：未找到 >=0 找到位置
     */
    private int getPinnedHeaderViewPosition(int adapterFirstVisible, RecyclerAdapter adapter) {
